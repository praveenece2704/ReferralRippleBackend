...
public class UserService {
	...
	public User registerUser(UserRegistrationDTO user) {
		...
		if (checkUser == null) {
			...
			userdata.setPassword(userSecurity.passwordEncoder(user.getPassword()));
	...
	public User validateReferralCode(String code) {
		...
		try {
			...
			System.out.println("Exception while validate referralCode" + e);
		}
		return null;
	}
}
